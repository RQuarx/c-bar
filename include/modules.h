 ...
 *
 * @return A valid path if the socket path is found, or NULL.
 */
...
gpointer
    ...
    /** @brief Thread function for current time and battery level listener. */
    ...
    battery_level_reader(gpointer reader);
